...
public class StringRegexUtils {
    ...
    public static Map<String, String> addressResolution(String address) {
        ...
        while (m.find()) {
            ...
            if (str.length() > 0) {
                if (str.endsWith("省")) {
                    table.put("province", str);
                } else if ((str.endsWith("市") || str.endsWith("岛") || str.endsWith("自治州")) && StringUtils.isBlank(table.get("city"))) {
                    table.put("city", str);
                } else if ((str.endsWith("区") || str.endsWith("县") || str.endsWith("市")) && StringUtils.isBlank(table.get("region"))) {
                    table.put("region", str);
                }
            }
        }
        return table;
...
## 3.2、Use MultipartBody to upload multiple types of data at the same time
